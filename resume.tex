...
\begin{tabular}{r|l}
    ...
    \\
    \multirow{4}{*}{Languages} & Knowledge of SUS/POSIX and Linux APIs \\
                               & C (gdb, valgrind, make, autoconf, automake, m4, Other GNU development tools), C++ \\
                               & Shell scripting (bourne-again shell, almquist shell), Python, other scripting languages \\
                               & Ansible, Puppet \\
    \\
    \multirow{6}{*}{Concepts} & Agile trained developer \\
                              & Professional and personal use of GNU/Linux systems for over 8 years \\
